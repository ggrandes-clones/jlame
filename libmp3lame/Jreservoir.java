 ...
 */
		...
		if( gfc.pinfo != null ) {
			gfc.pinfo.mean_bits = meanBits >> 1; /* expected bits per channel per granule [is this also right for mono/stereo, MPEG-1/2 ?] */
	...
	*/
	static final long ResvMaxBits(final Jlame_internal_flags gfc, final int mean_bits,/* final int[] targ_bits, final int[] extra_bits,*/ final boolean cbr) {
		final JSessionConfig cfg = gfc.cfg;
		final JEncStateVar esv = gfc.sv_enc;
