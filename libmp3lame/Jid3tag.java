...
public final class Jid3tag {
	...
	private static final void copyV1ToV2(final Jlame_global_flags gfp, final int frame_id, final String s) {
...
*/
	...
	public static final int id3tag_set_albumart(final Jlame_global_flags gfp, final byte[] image, final int size) {
		if (is_lame_internal_flags_null(gfp)) {
			return 0;
		}
		final Jlame_internal_flags gfc = gfp.internal_flags;
...
*/
	...
	private static final JFrameDataNode findNode(final Jid3tag_spec tag, final int frame_id, final JFrameDataNode last) {
	...
	private static final boolean isSameDescriptor(final JFrameDataNode node, final byte[] dsc, final boolean isUnicode) {
	...
	private static final int id3v2_add(final Jlame_global_flags gfp, final int frame_id, final String lng, final String desc, final String text, final boolean isUnicode) {
		final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
		if( gfc != null ) {
			byte[] bdesc = null;
			if( desc != null ) {
	...
	private static final int id3v2_add_lng(final Jlame_global_flags gfp, final int frame_id, final String desc, final String text, final boolean isEncode)
	{
	    final String lang = id3v2_get_language( gfp );
	    return id3v2_add( gfp, frame_id, lang, desc, text, isEncode );
	}

	private static final int id3tag_set_userinfo(final Jlame_global_flags gfp, final int id, final String fieldvalue, final boolean isEncode) {
		int rc = -7;
	...
	public static final int id3tag_set_textinfo(final Jlame_global_flags gfp, final String id, final String text, final boolean isEncode) {
	...
	public static final int id3tag_set_comment(final Jlame_global_flags gfp, final String lang, final String desc, final String text, final boolean isEncode) {
		if( is_lame_internal_flags_null( gfp ) ) {
			return 0;
		}
...
*/
	...
	private static final int set_frame_comment(final byte[] buffer, int frame, final JFrameDataNode node) {
	...
	private static final int set_frame_custom2(final byte[] buffer, int frame, final JFrameDataNode node) {
	...
	private static final int set_frame_wxxx(final byte[] buffer, int frame, final JFrameDataNode node) {
	...
	public static final int id3tag_set_fieldvalue(final Jlame_global_flags gfp, final String fieldvalue, final boolean isEncode) {
		if( is_lame_internal_flags_null( gfp ) ) {
			return 0;
		}
	...
	public static final int lame_get_id3v2_tag(final Jlame_global_flags gfp, final byte[] buffer, final int size) {
		if( is_lame_internal_flags_null( gfp ) ) {
			return 0;
		}
		final Jlame_internal_flags gfc = gfp.internal_flags;
	...
	public static final int lame_get_id3v1_tag(final Jlame_global_flags gfp, final byte[] buffer, final int size) {
		if( gfp == null ) {
			return 0;
		}
